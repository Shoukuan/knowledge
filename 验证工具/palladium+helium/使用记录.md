...
<!-- TOC -->
  ...
  - [（1）DB路径](#1db)
  - [（2）波形](#2)
  - [（3）Trigger File](#3trigger-file)
  - [（4）Probe stream signal](#4probe-stream-signal)
  - [（5） Force nets](#5-force-nets)
  - [（6）run](#6run)
  - [（7） source include.tcl](#7-source-includetcl)
  - [（8）Memory Load](#8memory-load)
